...
INSERT INTO content_tb (
    ...
    director, introduction, characteristic, play_time, product_year, writers,
    actors, view_count, rate, genre, created_at
) VALUES ('부산행','/static/images/dummy/train_to_busan/thumbnail.webp','/static/images/dummy/train_to_busan/main-photo.jpg','/static/images/dummy/train_to_busan/main-photo.jpg','/static/images/dummy/train_to_busan/poster-photo.webp','/static/images/dummy/train_to_busan/text-photo.webp','연상호','좀비 바이러스가 온 나라를 휩쓸면서, 단 하나 남은 안전한 도시로 가기 위해 딸과 함께 열차에 몸을 실은 남자. 살아남기 위한 극한의 사투가 시작된다.','긴박감 넘치는, 긴장감 넘치는','1시간 57분','2016','박주석','공유, 정유미, 마동석, 최우식, 안소희 등',20 ,'PG','HORROR', NOW()),
         ('랑종','/static/images/dummy/rangjong/thumbnail.webp','/static/images/dummy/rangjong/main-photo.webp','/static/images/dummy/rangjong/main-photo.webp','/static/images/dummy/rangjong/poster-photo.webp','/static/images/dummy/rangjong/text-photo.webp','반종 피산다나쿤','한 여성이 갈수록 이상한 행동을 하자, 어두운 비밀을 밝혀야 하는 무당. 가문에 얽힌 불길한 오랜 저주를 마주해야 한다.','으스스한, 불길한, 무서운','2시간 10분','2021','나홍진','나릴야 군몽콘켓, 싸와니 우툼마, 씨라니 얀키띠칸',  1,'R','HORROR',NOW()),
         ('월드 워 Z','/static/images/dummy/wolrd_war_z/thumbnail.webp','/static/images/dummy/wolrd_war_z/main-photo.webp','/static/images/dummy/wolrd_war_z/main-photo.webp','/static/images/dummy/wolrd_war_z/poster-photo.webp','/static/images/dummy/wolrd_war_z/text-photo.webp','마크 포스터','인간을 괴물로 만드는 바이러스의 습격을 다룬 재난 스릴러 영화. 《Variety》가 ‘상상력과 몰입감이 돋보이는 새로운 작품이 좀비 영화 대열에 합류했다. ’라고 호평했다.','긴박감 넘치는, 폭력적인, 무서운','1시간 57분','2013','매튜 마이클 캐너핸, 드류 고다드','브래드 피트, 미레유 에노스',  10 ,'PG','HORROR',NOW()),
         ('곤지암','/static/images/dummy/gonziam/thumbnail.webp','/static/images/dummy/gonziam/main-photo.webp','/static/images/dummy/gonziam/main-photo.webp','/static/images/dummy/gonziam/poster-photo.webp','/static/images/dummy/gonziam/text-photo.webp','정범식','환자의 집단 자살과 병원장 실종 이후로 버려진 곤지암 정신병원. 흉가로 유명한 이곳에 체험단 7명이 인터넷 방송을 위해 발을 들인다. 이들의 목표는, 열리지 않는 402호에 들어가는 것. 하지만 촬영 시작부터 괴담이 현실이 된다.','으스스한, 어두운, 무서운','1시간 34분','2018','정범식','위하준, 박지현, 오아연, 박성훈',  3 ,'PG','HORROR',NOW()),
         ('조커','/static/images/dummy/joker/thumbnail.webp','/static/images/dummy/joker/main-photo.webp','/static/images/dummy/joker/main-photo.webp','/static/images/dummy/joker/poster-photo.webp','/static/images/dummy/joker/text-photo.webp','토드 필립스','1981년 고담시. 정신과 병력이 있는 코미디언 지망생이 대중의 관심을 얻으려 고군분투한다. 어느 날 자신을 공격한 이들에게 반격을 가하는데 그로부터 삶이 어둡고 처참한 방향으로 치닫기 시작한다.','폭력적인, 어두운','2시간 1분','2019','토드 필립스','호아킨 피닉스, 로버트 드 니로',  3 ,'PG','THRILLER',NOW()),
         ('스마트폰을 떨어뜨렸을 뿐인데','/static/images/dummy/smartphone_drop/thumbnail.jpg','/static/images/dummy/smartphone_drop/main-photo.webp','/static/images/dummy/smartphone_drop/main-photo.webp','/static/images/dummy/smartphone_drop/poster-photo.webp','/static/images/dummy/smartphone_drop/text-photo.webp','김태준','젊은 여성의 스마트폰을 손에 넣은 살인범. 스마트폰을 이용해 그녀의 신분을 도용하고 삶을 갉아먹기 시작한다. 손에 땀을 쥐게 하는 스릴러.','긴장감 넘치는','1시간 57분','2023','김태준','천우희, 임시완, 김희원',  2 ,'PG','THRILLER',NOW()),

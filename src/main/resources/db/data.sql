...
INSERT INTO user_tb (email, password, username, mobile, profile_icon_id, status, is_kids, login_save, is_auto_play, is_subscribe, created_at)
VALUES
    ('admin1@example.com', '1234', 'adminUser', '010-1111-1111', 1, 'ADMIN', false, true, true, true, NOW()),
    ('user2@example.com', '1234', 'user2', '010-2222-2222', 2, 'USER', false, false, true, true, NOW()),
    ('user3@example.com', '1234', 'user3', '010-3333-3333', 3, 'USER', true, false, true, false, NOW()),
    ('user4@example.com', '1234', 'user4', '010-4444-4444', 4, 'USER', false, true, false, true, NOW()),
    ('user5@example.com', '1234', 'user5', '010-5555-5555', 5, 'USER', false, false, true, false, NOW()),
    ('user6@example.com', '1234', 'user6', '010-6666-6666', 6, 'USER', true, true, false, true, NOW()),
    ('user7@example.com', '1234', 'user7', '010-7777-7777', 7, 'USER', false, false, false, true, NOW()),
    ('user8@example.com', '1234', 'user8', '010-8888-8888', 8, 'USER', true, false, true, false, NOW()),
    ('user9@example.com', '1234', 'user9', '010-9999-9999', 9, 'USER', false, true, false, true, NOW()),
    ('user10@example.com', '1234', 'user10', '010-1111-0000', 10, 'USER', true, false, false, false, NOW());
